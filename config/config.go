...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("StampzGo_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("StampzGo.config") // Configuration fileName without the .TOML or .YAML extension
	}
